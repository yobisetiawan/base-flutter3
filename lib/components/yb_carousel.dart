...
enum YbIndicatorPosition { left, center, right }

class YbCarousel extends StatefulWidget {
  ...
  const YbCarousel({
    ...
    this.paginationPositionn = YbIndicatorPosition.center,
  }) : super(key: key);

  final YbIndicatorPosition? paginationPositionn;
  ...
  @override
  State<YbCarousel> createState() => _YbCarouselState();
}

class _YbCarouselState extends State<YbCarousel> with TickerProviderStateMixin {
  Timer? timer;
  ...
  double? veluePaginationPosition(String k) {
    if (k == 'left') {
      if (widget.paginationPositionn == YbIndicatorPosition.left ||
          widget.paginationPositionn == YbIndicatorPosition.center) {
        return 0;
      }
    }

    if (k == 'right') {
      if (widget.paginationPositionn == YbIndicatorPosition.right ||
          widget.paginationPositionn == YbIndicatorPosition.center) {
        return 0;
      }
    }
  ...
  Widget build(BuildContext context) => Stack(
        children: <Widget>[
          ...
          widget.hasPagination == true
              ? Positioned(
                  left: veluePaginationPosition('left'),
                  right: veluePaginationPosition('right'),
                  bottom: 0,
                  child: Container(
