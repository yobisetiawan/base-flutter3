...
import 'package:app3/pages/ecomerce.dart';
...
class Routes {
  static final List<GetPage<dynamic>> pages = [
    ...
    GetPage(
        name: RouteName.infinityScroll, page: () => const InfinityScrollPage()),
    GetPage(name: RouteName.ecomerce, page: () => const EcomercePage()),
  ];
}
